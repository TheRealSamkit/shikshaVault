<div class="d-flex flex-column h-100">
    <a href="/" class="d-none d-md-flex align-items-center mb-3 mb-md-0 text-body text-decoration-none">
    ...
    <ul class="nav nav-pills flex-column p-2">
        ...
        <li>
            <a href="{{ route('upload.uploadForm') }}"
                class="nav-link {{ request()->routeIs('upload.*') ? 'active' : '' }}" wire:navigate>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="icon icon-tabler icons-tabler-outline icon-tabler-cloud-up">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
